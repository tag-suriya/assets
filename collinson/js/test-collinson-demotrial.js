...
jQuery(document).ready(function ($) {
  ...
  function getTokenPolicyDetails(bodyobject) {
    ...
    fetch(
      "https://claim-proxy-lower.collinsonnis.com/api/policy",
      requestOptions
    )
      .then((response) => {
        statusCode = response.status;
  ...
  if ($(".edit_helpdesk_ticket").length > 0) {
    $(".card-body:eq(0)").wrap(
      "<div id='collapseSection7' class='order7 wrap_div_7 collapse show' data-parent='#accordion' aria-labelledby='overall_div_7' ></div>"
    );
      ...
      if (
        ...
        if ($("input[data-ispolicyholder='true']:checked").length) {
          ...
          $("input[name='insured_1']:checked").each(function () {
            console.log("----your array -->", $(this).attr("data-clientid"));
            console.log(
              "---name Array--->",
          ...
          console.log(
            "---before setting it into OtherInsuredClientIds ---->",
            yourArray
          );
  ...
  $(".new-ticket-dummy").click(function () {
    ...
    if ($("input[data-ispolicyholder='true']:checked").length) {
      ...
      console.log("------->.new-ticket-dummy--if--yourArray--> ", yourArray);
      ...
      console.log("------->.new-ticket-dummy--else-yourArray--> ", yourArray);
      body["OtherInsuredClientIds"] = yourArray;
    }
    console.log(body);
