...
jQuery(document).ready(function ($) {
  ...
  $(".ins-col-test").click(function () {
    ...
    // Skip if the icon is a pen
    if ($icon.hasClass("fa-pen")) return;

    // Proceed only if it's a collapse trigger
    if ($(this).attr("data-bs-toggle") === "collapse") {
      if ($(this).hasClass("collapsed") && $icon.hasClass("fa-plus")) {
        $icon.removeClass("fa-plus").addClass("fa-minus");
      } else if (!$icon.hasClass("collapsed") && $icon.hasClass("fa-minus")) {
