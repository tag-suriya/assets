...
jQuery(document).ready(function ($) {
    ...
    if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
      ...
      if ($("#title").hasClass("VHI") || $("#title").hasClass("ColumbusItaly")) {
        ...
        // var currencyPaymentDropdown = document.getElementById(
        //   "helpdesk_ticket_custom_field_cf_what_currency_would_you_like_to_be_paid_in_2321673"
        // ).parentElement;
        // currencyPaymentDropdown.classList.add("for-section-6");
        var accHolderParent = document.getElementById(
          "helpdesk_ticket_custom_field_cf_name_of_account_holder_2321673"
        ).parentElement;
        accHolderParent.classList.add("for-section-6");
        ...
        $(
          ".form-group.helpdesk_ticket_custom_field_cf_what_currency_would_you_like_to_be_paid_in_2321673"
        ).addClass("for-section-6");
      } else if ($("#title").hasClass("EasyJet")) {
        //Name of acc holder - put in section 6
        var accHolderParent = document.getElementById(
    ...
    currencySelect.addEventListener("change", (event) => {
      ...
      if (selectedCurrency == "Sterling (GBP)") {
        console.log("------inside GBP");
        $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
          .closest(".form-group")
          .hide();
        $("#helpdesk_ticket_custom_field_cf_account_number694591_2321673")
        ...
        $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
          .closest(".form-group")
          .show();
      } else if (selectedCurrency == "Euro (EU)") {
        $("#helpdesk_ticket_custom_field_cf_account_number694591_2321673")
          .closest(".form-group")
          .hide();
        $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
    ...
    $("#save_and_continue6").click(function () {
      if ($("#title").hasClass("VHI") || $("#title").hasClass("ColumbusItaly")) {
        ...
        // helpdesk_ticket_custom_field_cf_name_of_account_holder_2321673
        // helpdesk_ticket_custom_field_cf_account_number694591_2321673
        if (currencySelectOption == "Sterling (GBP)") {
          payment_list = [
            "helpdesk_ticket_custom_field_cf_sort_code659991_2321673",
            "helpdesk_ticket_custom_field_cf_account_number694591_2321673",
            "helpdesk_ticket_custom_field_cf_name_of_account_holder_2321673",
          ...
          payment_list = ["helpdesk_ticket_custom_field_cf_iban_number_2321673"];
        }
