...
jQuery(document).ready(function ($) {
  ...
  $(".ins-col-test").click(function () {
    var id = $(this).attr("id"); // e.g., "section-1-button"
    var sectionNumber = id.split("-")[1]; // Extract number from id
    var targetId = "#collapseSection" + sectionNumber;
    var $icon = $(this).children(":first");

    if (!$icon.hasClass("fa-pen")) {
      var collapseEl = document.getElementById("collapseSection" + sectionNumber);
      ...
      $(".collapse").each(function () {
        if (this.id !== "collapseSection" + sectionNumber) {
