...
jQuery(document).ready(function ($) {
  ...
  function buildPolicyUI(policyData) {
    ...
    if ($("#title").hasClass("ColumbusItaly")) {
      ...
      options +=
        '<div Ã‚ class="form-group"><label id="insured-bold" class="form-label" style="display:inline-table;font-weight: 900;" > Name(s) of the Insured. Please TICK everyone who was involved in the claim! </label><br><label id="selectAClaiment">Please select a claimant</label>';
    }
  ...
  var ClaimReason = [
    {
      ...
      name_ita: "Sinistri relativi a Covid 19 Ã¢â‚¬â€œ Cancellazione",
    },
    {
    ...
    },
    {
      ...
      name_ita: "Ritardo del bagaglio allÃ¢â‚¬â„¢arrivo a destinanzione",
    },
    {
      id: "01_03_CxIllClnt",
    ...
    {
      id: "01_02_Curt",
      name_eng: "Curtailment Ã¢â‚¬â€œ returned home early",
  ...
  var CurrencyType = [
    ...
    {
      id: "CRC",
      name_eng: "Costa Rican ColÃƒÂ³n",
      lang_ita: "ColÃƒÂ³n costaricano",
    },
    {
      id: "HRK",
    ...
    {
      id: "MNT",
      name_eng: "Mongolian tÃƒÂ¶grÃƒÂ¶g",
      lang_ita: "TÃƒÂ¶grÃƒÂ¶g Mongolo",
    },
    {
      id: "MAD",
  ...
  var LossTheftWhere = [
    {
      ...
      name_ita: "Dal tuo veicolo di proprietÃƒ  o in affitto",
    },
    {
  ...
  var SkiPackClaimReason = [
    ...
    },
    {
      ...
      name_ita: "PiÃƒÂ¹ di un oggetto elencato",
    },
  ];
  /* 5.9 End */
    ...
    fetch("https://" + domainURL + "/api/claim", requestOptions)
      ...
      .then(function (result) {
        ...
        if (flag) {
          ...
          if ($("#title").hasClass("ColumbusItaly")) {
            $(".claim-number").append(
              `Il tuo numero di reclamo ÃƒÂ¨ ${ClaimInitiatedNumber}`
            );
          } else {
            $(".claim-number").append(
  ...
  function CheckMandatoryValues() {
    ...
    //sus
      ...
      $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").val() ==
      "Curtailment Ã¢â‚¬â€œ returned home early"
    ) {
      console.log(
        $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").val()
      );
  ...
  var reasonForClaimObj = {
    ...
    "Baggage - suitcase hasn't arrived on time": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: PuÃ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Il rapporto di irregolaritÃ   bagaglio rilasciato dal vettore.<br>Scontrino/ricevuta d'acquisto per il bene di prima nececessitÃ  .<br>",
      titles: ["Booking Invoice", "Other Docs"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Other+doc.png",
    ...
    "Cancelled trip - (NOT related to COVID-19)": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: PuÃ² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Documento di cancellazione della prenotazione che indichi le somme a tuo carico. Questo per ogni prenotazione.<br>Documenti che evidenzino la nececessitÃ   di disdetta Documentazione che indichi la nececessitÃ   di cancellare il viaggio es. Documentazione medica.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
