...
jQuery(document).ready(function ($) {
  ...
  var german_titles = [
    ...
    "Ãœber Sie",
    "Ãœber Ihre Reise",
    "Bitte erzÃ¤hlen Sie uns was passiert ist",
    "Ihre Dokumente",
    "Ihre Zahlungsdetails",
    "Ihre AnspruchsÃ¼bersicht",
  ];
  var french_titles = [
    "Votre police",
    "Vos informations",
    "Ãƒ propos de votre voyage",
    "Dites-nous ce qui s'est passÃ©",
    "Vos documents",
    "Vos dÃ©tails de paiement",
    "RÃ©sumÃ© de votre rÃ©clamation",
  ];
  var portuguese_titles = [
    ...
    "Resumo da sua reclamaÃ§Ã£o",
  ];
  var spanish_titles = [
    "Tu Poliza",
    "InformaciÃ³n sobre usted",
    "Acerca de tu viaje",
    "CuÃ©ntanos quÃ© pasÃ³",
    "Tus documentos",
    "Tus detalles de pago",
    "Tu Resumen de ReclamaciÃ³n",
  ];
  ...
  if (currentUrl.includes("/it/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/it/support/tickets/new")
    // Italian
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_dob">Chiamata API fallita</div>'
      );
  } else if (currentUrl.includes("/de/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/de/support/tickets/new")
    // German
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_dob">API-Aufruf fehlgeschlagen</div>'
      );
  } else if (currentUrl.includes("/es/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
    // Spanish
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_dob">Llamada a la API fallida</div>'
      );
  } else if (currentUrl.includes("/pt-PT/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
    // Portuguese
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_dob">Chamada API falhou</div>'
      );
  } else if (currentUrl.includes("/fr/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
    // French
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_dob">Appel API ÃƒÂ©chouÃƒÂ©</div>'
      );
  } else if (currentUrl.includes("/en/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/en/support/tickets/new")
    // English
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
        '<div id="captcha-section"><label>Captcha eingeben</label><div id="captcha"></div><input type="text" placeholder="Captcha" id="cpatchaTextBox"/></div>'
      );
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
    ...
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
        '<div id="captcha-section"><label>Inserir captcha</label><div id="captcha"></div><input type="text" placeholder="Captcha" id="cpatchaTextBox"/></div>'
      );
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
    ...
    $("#helpdesk_ticket_custom_field_cf_policy_email_2321673")
      .closest(".form-group")
      .append(
        '<div id="captcha-section"><label>Introducir Captcha</label><div id="captcha"></div><input type="text" placeholder="Captcha" id="cpatchaTextBox"/></div>'
      );
    $("#helpdesk_ticket_custom_field_cf_date_of_birth_2321673")
      .closest(".form-group")
      .append(
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $(
      ...
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_rc">Chiamata API fallita</div>'
      );
    $("#attachments_list")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_filelist">Chiamata API fallita</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_banvalidate">Chiamata API fallita</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_sortcodevalidate">Chiamata API fallita</div>'
      );
  } else if (currentUrl.includes("/de/")) {
    // German
    $(
      ...
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_rc">API-Aufruf fehlgeschlagen</div>'
      );
    $("#attachments_list")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_filelist">API-Aufruf fehlgeschlagen</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_banvalidate">API-Aufruf fehlgeschlagen</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_sortcodevalidate">API-Aufruf fehlgeschlagen</div>'
      );
  } else if (currentUrl.includes("/es/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
    // Spanish
    $(
      ...
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_rc">Llamada a la API fallida</div>'
      );
    $("#attachments_list")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_filelist">Llamada a la API fallida</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_banvalidate">Llamada a la API fallida</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_sortcodevalidate">Llamada a la API fallida</div>'
      );
  } else if (currentUrl.includes("/pt-PT/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
    // Portuguese
    $(
      ...
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_rc">Chamada API falhou</div>'
      );
    $("#attachments_list")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_filelist">Chamada API falhou</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_banvalidate">Chamada API falhou</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_sortcodevalidate">Chamada API falhou</div>'
      );
  } else if (currentUrl.includes("/fr/")) {
    // French
    $(
      ...
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_rc">Appel API ÃƒÂ©chouÃƒÂ©</div>'
      );
    $("#attachments_list")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_filelist">Appel API ÃƒÂ©chouÃƒÂ©</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_iban_number_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_banvalidate">Appel API ÃƒÂ©chouÃƒÂ©</div>'
      );
    $("#helpdesk_ticket_custom_field_cf_sort_code659991_2321673")
      .closest(".form-group")
      .append(
        '<div class="invalid-feedback api_call_failed_sortcodevalidate">Appel API ÃƒÂ©chouÃƒÂ©</div>'
      );
  } else if (currentUrl.includes("/en/")) {
  ...
  if (currentUrl.includes("/it/")) {
    ...
    jQuery(".new-ticket-submit-button")
      ...
      .find(".form-group")
      .before(
        '<div class="invalid-feedback common_error">Bitte fÃ¼llen Sie alle Felder aus</div>'
      );
    //SPANISH
  } else if (currentUrl.includes("/es/")) {
    // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
    ...
    jQuery(".new-ticket-submit-button")
      ...
      .find(".form-group")
      .before(
        '<div class="invalid-feedback common_error">Merci de remplir tous les champs</div>'
      );
  }
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $("button.new-ticket-submit-button")
      .hide()
      .after(
        '<span class="btn fw-primary-button new-ticket-dummy for-section-7">Mandar</span>'
      );
    $("button#helpdesk_ticket_submit")
      .hide()
      .after(
  ...
  if ($("#new_helpdesk_ticket").length || $(".edit_helpdesk_ticket").length) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Versicherungspolice suchen</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (currentUrl.includes("/es/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
      // Spanish
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Encontrar pÃ³liza</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      $(
        '<button id="save_and_continue1" class="btn btn-primary for-section-1 save_and_continue" type="button">Localizar apÃ³lice</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_claim_number_2321673");
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue2" class="btn btn-primary for-section-2 save_and_continue" type="button" >Weiter</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_mobile_number_2321673");
    } else if (currentUrl.includes("/es/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
      // Spanish
      $(
        '<button id="save_and_continue2" class="btn btn-primary for-section-2 save_and_continue" type="button" >Continuar</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_mobile_number_2321673");
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      ...
      // French
      $(
        '<button id="save_and_continue2" class="btn btn-primary for-section-2 save_and_continue" type="button" >Continuer</button>'
      ).insertAfter("#helpdesk_ticket_custom_field_cf_mobile_number_2321673");
    } else if (currentUrl.includes("/en/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/en/support/tickets/new")
      // English
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue3" class="btn btn-primary for-section-3 save_and_continue" type="button" >Weiter</button>'
      ).insertAfter(
        ".form-group.helpdesk_ticket_custom_field_cf_reason_for_claim_2321673.for-section-3"
      );
    } else if (currentUrl.includes("/es/")) {
      ...
      // Spanish
      $(
        '<button id="save_and_continue3" class="btn btn-primary for-section-3 save_and_continue" type="button" >Continuar</button>'
      ).insertAfter(
        ".form-group.helpdesk_ticket_custom_field_cf_reason_for_claim_2321673.for-section-3"
      );
    } else if (currentUrl.includes("/pt-PT/")) {
      ...
      // French
      $(
        '<button id="save_and_continue3" class="btn btn-primary for-section-3 save_and_continue" type="button" >Continuer</button>'
      ).insertAfter(
        ".form-group.helpdesk_ticket_custom_field_cf_reason_for_claim_2321673.for-section-3"
      );
    } else if (currentUrl.includes("/en/")) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue4" class="btn btn-primary for-section-4 save_and_continue" type="button">Weiter</button>'
      ).insertAfter(
        ".helpdesk_ticket_custom_field_cf_reason_for_claim_2321673_section_wrapper"
      );
    } else if (currentUrl.includes("/es/")) {
      // Spanish
      $(
        '<button id="save_and_continue4" class="btn btn-primary for-section-4 save_and_continue" type="button">Continuar</button>'
      ).insertAfter(
        ".helpdesk_ticket_custom_field_cf_reason_for_claim_2321673_section_wrapper"
      );
    } else if (currentUrl.includes("/pt-PT/")) {
      ...
      // French
      $(
        '<button id="save_and_continue4" class="btn btn-primary for-section-4 save_and_continue" type="button">Continuer</button>'
      ).insertAfter(
        ".helpdesk_ticket_custom_field_cf_reason_for_claim_2321673_section_wrapper"
      );
    } else if (currentUrl.includes("/en/")) {
  ...
  if (jQuery(".fw-comments-wrapper").length > 0) {
    ...
    if (
      ...
      // Portuguese
      $(
        '<button class="save_and_continue5 btn btn-primary for-section-5 save_and_continue" type="button" >PrÃ³xima sesiÃ³n</button>'
      ).insertAfter(".attachments.for-section-5");
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
  ...
  if ($("#new_helpdesk_ticket").length || $(".fw-comments-wrapper").length) {
    ...
    if (currentUrl.includes("/it/")) {
      ...
      // German
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >Weiter</button>'
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/es/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/es/support/tickets/new")
      // Spanish
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >Continuar</button>'
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/pt-PT/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/pt-PT/support/tickets/new")
      // Portuguese
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >PrÃ³xima sesiÃ³n</button>'
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/fr/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/fr/support/tickets/new")
      // French
      $(
        '<button id="save_and_continue6" class="btn btn-primary for-section-6 save_and_continue" type="button" >Section suivante</button>'
      ).insertAfter(ibanNumber);
    } else if (currentUrl.includes("/en/")) {
      // (window.location.href == "https://easyjeteu.freshdesk.com/en/support/tickets/new")
      // English
  ...
  if (currentUrl.includes("/it/")) {
    ...
    $('#collapseSection5').children('.card-body').prepend("<p>TUTTI i documenti caricati non devono superare i 5MB!</p>") 
  } else if (currentUrl.includes("/en/")) {
    ...
    $('#collapseSection5').children('.card-body').prepend("<p>ALL documents being uploaded must not exceed 5MB!</p>") 
  } else if (currentUrl.includes("/de/")) {
    
    for (var i = 0; i < german_titles.length; ++i) {
      thisDiv(i + 1, german_titles[i]);
    }
    $('#collapseSection5').children('.card-body').prepend("<p>ALLE hochgeladenen Dokumente dÃ¼rfen 5MB nicht Ã¼berschreiten!</p>") 
    ...
    $('#collapseSection5').children('.card-body').prepend("<p>TOUS les documents tÃ©lÃ©chargÃ©s ne doivent pas dÃ©passer 5MB!</p>") 
    ...
    $('#collapseSection5').children('.card-body').prepend("<p>Â¡TODOS los documentos que se suban no deben exceder los 5MB!</p>") 
    ...
    $('#collapseSection5').children('.card-body').prepend("<p>TODOS os documentos enviados nÃ£o devem exceder 5MB!") 
  ...
  function show_and_hide(
    ...
    $(element_to_check).change(function () {
      ...
      if ($(element_to_check).val() == condition_to_check_for) {
        console.log(elements_to_toggle)
        for (let i = 0; i < elements_to_toggle.length; i++) {
    ...
    $("#" + element_ID).focusout(function () {
      ...
      if (today < test_date) {
        ...
        if (currentUrl.includes("/it/")) {    
          ...
          addErrorMessage(element_ID, "La data deve essere passata o presente.");
        
        } else if (currentUrl.includes("/es/")) {    
          
          addErrorMessage(element_ID, "La fecha debe estar en pasado o presente.");
        
        } else if (currentUrl.includes("/fr/")) {    
          
          addErrorMessage(element_ID, "La date doit Ãªtre dans le passÃ© ou le prÃ©sent.");
        
        } else if (currentUrl.includes("/de/")) {    
          
          addErrorMessage(element_ID, "Das Datum muss in der Vergangenheit oder Gegenwart liegen.");
        
        } else if (currentUrl.includes("/pt-PT/")) {    
          
          addErrorMessage(element_ID, "A data deve ser passada ou presente.");
  ...
  function summary_section_start() {
    ...
    if ($("#summary_intro").length) {
      ...
      // if ($("#title").hasClass("ColumbusItaly")) {
        ...
        $(
          '<p id="summary_intro">Bitte nehmen Sie sich einen Moment Zeit, um Ihre Informationen zu Ã¼berprÃ¼fen - Genauigkeit hilft uns dabei, Ihren Anspruch schnell zu bearbeiten.</p>'
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");

      }else if (currentUrl.includes("/es/")) {
        
        $(
          '<p id="summary_intro">Por favor, tÃ³mese un momento para revisar su informaciÃ³n: la precisiÃ³n nos ayuda a procesar su reclamaciÃ³n rÃ¡pidamente.</p>'
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");

      } else if (currentUrl.includes("/fr/")) {
        
        $(
          '<p id="summary_intro">Veuillez prendre un moment pour vÃ©rifier vos informations : leur exactitude nous aide Ã  traiter votre demande rapidement.</p>'
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");

      } else if (currentUrl.includes("/pt-PT/")) {
        
        $(
          '<p id="summary_intro">Reserve um momento para verificar suas informaÃ§Ãµes. A precisÃ£o nos ajuda a processar sua reclamaÃ§Ã£o rapidamente.</p>'
        ).insertBefore(".form-group.helpdesk_ticket_email.for-section-7");
  ...
  $("#save_and_continue1").click(function () {
    if ($("#title").hasClass("EasyJet")||$("#portalClass").hasClass("EasyJetEU")) {
      //checkRecaptcha
      if (
        ...
        if (currentUrl.includes("/it/")) {
          ...
          addErrorMessage(
            "captcha_failed",
            "UngÃ¼ltiges Captcha. Bitte geben Sie das Captcha erneut ein."
          );
          createCaptcha();
        } else if (currentUrl.includes("/es/")) {
          addErrorMessage(
            "captcha_failed",
            "Captcha invÃ¡lido. Por favor vuelve a ingresar el captcha"
          );
          createCaptcha();
        } else if (currentUrl.includes("/pt-PT/")) {
          addErrorMessage(
            "captcha_failed",
            "Captcha invÃ¡lido. Por favor digite novamente o captcha"
          );
          createCaptcha();
        } else if (currentUrl.includes("/pt-BR/")) {
          addErrorMessage(
          ...
          addErrorMessage(
            "captcha_failed",
            "Captcha invalide. Veuillez saisir Ã  nouveau le captcha"
          );
          createCaptcha();
        } else {
          addErrorMessage(
      ...
      if (
        ...
        if (
          ...
          // if ($("#title").hasClass("ColumbusItaly")) {
            ...
            addErrorMessage(
              "helpdesk_ticket_custom_field_cf_policy_number_post_office_2321673",
              "Por favor preencha todos los campos"
            );
            addErrorMessage(
              "helpdesk_ticket_custom_field_cf_policy_email_2321673",
              "Por favor preencha todos los campos"
        ...
        if (flag) {
          ...
          if (statusCode == 401) {
            ...
            // if ($("#title").hasClass("ColumbusItaly")) {
              ...
              jQuery("#model-error-msg").removeClass("d-none");
              jQuery("#model-error-msg .ins-modal-body-content").text(
                "Hier stimmt etwas nicht. Bitte versuchen Sie es noch einmal mit der auf Ihrem Versicherungsschein angegebenen Versicherungsnummer.Abbrechen"
              );
              addErrorMessage(
                "api_call_failed_dob",
                "Hier stimmt etwas nicht. Bitte versuchen Sie es noch einmal mit der auf Ihrem Versicherungsschein angegebenen Versicherungsnummer.Abbrechen"
              ...
              jQuery("#model-error-msg").removeClass("d-none");
              jQuery("#model-error-msg .ins-modal-body-content").text(
                "Advertencia Algo no estÃ¡ del todo bien. Por favor, intÃ©ntalo de nuevo y si el problema persiste, ponte en contacto con el equipo utilizando el botÃ³n 'ContÃ¡ctanos' en el pie de pÃ¡gina."
              );
              addErrorMessage(
                "api_call_failed_dob",
                "Advertencia Algo no estÃ¡ del todo bien. Por favor, intÃ©ntalo de nuevo y si el problema persiste, ponte en contacto con el equipo utilizando el botÃ³n 'ContÃ¡ctanos' en el pie de pÃ¡gina."
              ...
              jQuery("#model-error-msg").removeClass("d-none");
              jQuery("#model-error-msg .ins-modal-body-content").text(
                "Avertissement.  quelque chose ne va pas. Veuillez rÃ©essayer et si le problÃ¨me persiste, veuillez contacter l'Ã©quipe en utilisant le bouton Â«Â Contactez-nousÂ Â» en pied de page."
              );
              addErrorMessage(
                "api_call_failed_dob",
                "Avertissement.  quelque chose ne va pas. Veuillez rÃ©essayer et si le problÃ¨me persiste, veuillez contacter l'Ã©quipe en utilisant le bouton Â«Â Contactez-nousÂ Â» en pied de page."
              ...
              jQuery("#model-error-msg").removeClass("d-none");
              jQuery("#model-error-msg .ins-modal-body-content").text(
                "Erro de polÃ­tica Estamos tendo problemas para encontrar sua apÃ³lice. Verifique as informaÃ§Ãµes inseridas em relaÃ§Ã£o ao cronograma da sua apÃ³lice. Ainda tendo problemas? VocÃª pode entrar em contato conosco aqui."
              );
              addErrorMessage(
                "api_call_failed_dob",
                "Erro de polÃ­tica Estamos tendo problemas para encontrar sua apÃ³lice. Verifique as informaÃ§Ãµes inseridas em relaÃ§Ã£o ao cronograma da sua apÃ³lice. Ainda tendo problemas? VocÃª pode entrar em contato conosco aqui."
  ...
  function buildPolicyUI(policyData) {
    ...
    if (currentUrl.includes("/it/")) {  
      ...
      options +=
      "<div ' class='form-group'><label class='form-label' id='insured-bold' style='display:inline-table;font-weight: 900;' >Bitte wÃ¤hlen Sie einen Antragsteller aus</label>"; 
        
    } else if (currentUrl.includes("/es/")) {
      options +=
        "<div ' class='form-group'><label class='form-label' id='insured-bold' style='display:inline-table;font-weight: 900;' >Por favor, selecciona un reclamante.</label>";
        
    } else if (currentUrl.includes("/fr/")) {
      options +=
        "<div ' class='form-group'><label class='form-label' id='insured-bold' style='display:inline-table;font-weight: 900;' >Veuillez sÃ©lectionner un demandeur</label>";
        
    } else if (currentUrl.includes("/pt-PT/")) {
      options +=
        "<div ' class='form-group'><label class='form-label' id='insured-bold' style='display:inline-table;font-weight: 900;' >Por favor, selecione um reclamante</label>";
      ...
      options +=
        '<div Ãƒâ€š class="form-group"><label id="insured-bold" class="form-label" style="display:inline-table;font-weight: 900;" > Name(s) of the Insured. Please TICK everyone who was involved in the claim! </label><br><label id="selectAClaiment">Please select a claimant</label>';
    }
  ...
  function add_section_1() {
    if (currentUrl.includes('/it/')) {
      ...
      $(
        "<strong id='section_1_header'>" + german_titles[0] + "</strong>"
      ).insertAfter("#summary_intro");
      $("<hr class='summary_divider' id='great_line_1'>").insertAfter(
        "#section_1_header"
      );
      ...
      $(
        "<strong id='section_1_header'>" + portuguese_titles[0] + "</strong>"
      ).insertAfter("#summary_intro");
      $("<hr class='summary_divider' id='great_line_1'>").insertAfter(
        "#section_1_header"
      );
      ...
      $(
        "<strong id='section_1_header'>" + french_titles[0] + "</strong>"
      ).insertAfter("#summary_intro");
      $("<hr class='summary_divider' id='great_line_1'>").insertAfter(
        "#section_1_header"
      );
      ...
      $(
        "<strong id='section_1_header'>" + spanish_titles[0] + "</strong>"
      ).insertAfter("#summary_intro");
      $("<hr class='summary_divider' id='great_line_1'>").insertAfter(
        "#section_1_header"
      );
  ...
  $("#save_and_continue2").click(function () {
    ...
    if (len <= 0) {
      // if ($("#title").hasClass("ColumbusItaly")) {
        ...
        addErrorMessage("check-finder", "Bitte wÃ¤hlen Sie mindestens einen Versicherten aus");
      } else if (currentUrl.includes("/fr/")) {
        addErrorMessage("check-finder", "Veuillez sÃ©lectionner au moins un client");
      } else if (currentUrl.includes("/pt-PT/")) {
        addErrorMessage("check-finder", "Selecione pelo menos um cliente");
      } else if (currentUrl.includes("/pt-BR/")) {
        addErrorMessage("check-finder", "Selecione pelo menos um cliente");
      } else if (currentUrl.includes("/es/")) {
        addErrorMessage("check-finder", "Por favor, selecciona un reclamante.");
      } else {
  ...
  function add_section_2() {
    if (currentUrl.includes('/it/')) {
      ...
      $(
        "<strong id='section_2_header'>" + german_titles[1] + "</strong>"
      ).insertAfter("#great_line_1");
      $("<hr class='summary_divider' id='great_line_2'>").insertAfter(
        "#section_2_header"
      );
      ...
      $(
        "<strong id='section_2_header'>" + portuguese_titles[1] + "</strong>"
      ).insertAfter("#great_line_1");
      $("<hr class='summary_divider' id='great_line_2'>").insertAfter(
        "#section_2_header"
      );
      ...
      $(
        "<strong id='section_2_header'>" + french_titles[1] + "</strong>"
      ).insertAfter("#great_line_1");
      $("<hr class='summary_divider' id='great_line_2'>").insertAfter(
        "#section_2_header"
      );
      ...
      $(
        "<strong id='section_2_header'>" + spanish_titles[1] + "</strong>"
      ).insertAfter("#great_line_1");
      $("<hr class='summary_divider' id='great_line_2'>").insertAfter(
        "#section_2_header"
      );
  ...
  var ClaimReason = [
    {
      ...
      name_ita: "Sinistri relativi a Covid 19 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ Cancellazione",
    },
    {
    ...
    {
      id: "01_02_Curt",
      name_eng: "Curtailment ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ returned home early",
  ...
  var CurrencyType = [
    {
      ...
      lang_spa: "DÃ³lar Estadounidense"
    },
    {
      id: "EUR",
      name_eng: "Euro",
    ...
    },
    {
      ...
      lang_spa: "Peso Colombiano"
    },
    {
      id: "CDF",
      name_eng: "Congolese Franc",
      lang_ita: "Franco Congolese",
      lang_spa: "Franco CongoleÃ±o"
    },
    {
      id: "CRC",
      name_eng: "Costa Rican ColÃƒÆ’Ã‚Â³n",
      lang_ita: "ColÃƒÆ’Ã‚Â³n costaricano",
      lang_spa: "ColÃ³n Costarricense"
    },
    {
      id: "HRK",
      name_eng: "Croatian Kuna",
      lang_ita: "Kuna Croata",
      lang_spa: "Kuna Croata"
    },
    {
      id: "CUP",
      name_eng: "Cuban Convertible Peso",
      lang_ita: "Peso Cubano Convertibile",
      lang_spa: "Peso Convertible Cubano"
    },
    {
      id: "CZK",
      name_eng: "Czech Koruna",
      lang_ita: "Corona Ceca",
      lang_spa: "Corona Checa"
    },
    {
      id: "DKK",
  ...
  var LossTheftWhere = [
    {
      ...
      name_ita: "Dal tuo veicolo di proprietÃƒÆ’  o in affitto",
    },
    {
  ...
  var SkiPackClaimReason = [
    ...
    },
    {
      ...
      name_ita: "PiÃƒÆ’Ã‚Â¹ di un oggetto elencato",
    },
  ];
  /* 5.9 End */
  ...
  function getAKey(id, array) {
    ...
    array.forEach(function (item) {
      if (item.name_eng == getval || item.name_ita == getval || item.name_spa == getval) {
        obj["akey"] = item.id;
      }
    });
    getitem.push(obj);
  ...
  function add_section_3() {
    if (currentUrl.includes('/it/')) {
      ...
      $(
        "<strong id='section_3_header'>" + german_titles[2] + "</strong>"
      ).insertAfter("#great_line_2");
      $("<hr class='summary_divider' id='great_line_3'>").insertAfter(
        "#section_3_header"
      );
      ...
      $(
        "<strong id='section_3_header'>" + portuguese_titles[2] + "</strong>"
      ).insertAfter("#great_line_2");
      $("<hr class='summary_divider' id='great_line_3'>").insertAfter(
        "#section_3_header"
      );
      ...
      $(
        "<strong id='section_3_header'>" + spanish_titles[2] + "</strong>"
      ).insertAfter("#great_line_2");
      $("<hr class='summary_divider' id='great_line_3'>").insertAfter(
        "#section_3_header"
      );
      ...
      $(
        "<strong id='section_3_header'>" + french_titles[2] + "</strong>"
      ).insertAfter("#great_line_2");
      $("<hr class='summary_divider' id='great_line_3'>").insertAfter(
        "#section_3_header"
      );
    ...
    fetch("https://" + domainURL + "/api/claim", requestOptions)
      ...
      .then(function (result) {
        ...
        if (flag) {
          ...
          if ($("#title").hasClass("ColumbusItaly")) {
            $(".claim-number").append(
              `Il tuo numero di reclamo ÃƒÆ’Ã‚Â¨ ${ClaimInitiatedNumber}`
            );
          } else {
            $(".claim-number").append(
  ...
  function CheckMandatoryValues() {
    ...
    //sus
      ...
      $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").val() ==
      "Curtailment ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ returned home early"
    ) {
      console.log(
        $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").val()
      );
  ...
  function add_section_4() {
    if (currentUrl.includes('/it/')) {
      ...
      $(
        "<strong id='section_4_header'>" + german_titles[3] + "</strong>"
      ).insertAfter("#great_line_3");
      $("<hr class='summary_divider' id='great_line_4'>").insertAfter(
        "#section_4_header"
      );
      ...
      $(
        "<strong id='section_4_header'>" + portuguese_titles[3] + "</strong>"
      ).insertAfter("#great_line_3");
      $("<hr class='summary_divider' id='great_line_4'>").insertAfter(
        "#section_4_header"
      );
      ...
      $(
        "<strong id='section_4_header'>" + french_titles[3] + "</strong>"
      ).insertAfter("#great_line_3");
      $("<hr class='summary_divider' id='great_line_4'>").insertAfter(
        "#section_4_header"
      );
      ...
      $(
        "<strong id='section_4_header'>" + spanish_titles[3] + "</strong>"
      ).insertAfter("#great_line_3");
      $("<hr class='summary_divider' id='great_line_4'>").insertAfter(
        "#section_4_header"
      );
  ...
  var reasonForClaimObj = {
    "Any CANCELLATION claim due to COVID-19": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Documento di cancellazione della prenotazione che indichi le somme a tuo carico. Questo per ogni prenotazione.<br>Documenti che evidenzino la necessitÃƒÆ’  di disdetta come la conferma della prenotazione per eventuale test Coronavirus e evidenza di esito positivo. ÃƒÆ’Ã‹â€  sufficiente solo la conferma tramite e-mail, non accettiamo la conferma tramite SMS.<br>",
      german_paragraph:"Wir benÃ¶tigen diese wichtigen Dokumente, um Ã¼ber Ihren Anspruch entscheiden zu kÃ¶nnen:<br>Die Buchungsrechnung Ihrer Reise mit Angabe der Kosten, Ihres Namens sowie des Abreise- und RÃ¼ckreisedatums.<br>Stornorechnung von jedem Unternehmen, bei dem Sie gebucht haben, mit Nachweis der StornogebÃ¼hr.<br>Dokumente, die die Notwendigkeit der Stornierung belegen, z. B. ein Ã¤rztliches Schreiben oder ein VerspÃ¤tungsbericht.<br>ALLE hochgeladenen Dokumente dÃ¼rfen nicht grÃ¶ÃŸer als 5 MB sein!",  
    ...
    "Baggage - personal items lost or stolen": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Denuncia alle autoritÃƒÆ’  locali che confermi gli eventi da cui ÃƒÆ’Ã‚Â¨ scaturito il sinistro.<br>Scontrino/ricevuta d'acquisto per il bene alla base del sinistro.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
    ...
    "Baggage - suitcase hasn't arrived on time": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Il rapporto di irregolaritÃƒÆ’  bagaglio rilasciato dal vettore.<br>Scontrino/ricevuta d'acquisto per il bene di prima necessitÃƒÆ’ .<br>",
      titles: ["Booking Invoice", "Other Docs"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Other+doc.png",
    ...
    "Cancelled trip - (NOT related to COVID-19)": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Documento di cancellazione della prenotazione che indichi le somme a tuo carico. Questo per ogni prenotazione.<br>Documenti che evidenzino la necessitÃƒÆ’  di disdetta Documentazione che indichi la necessitÃƒÆ’  di cancellare il viaggio es. Documentazione medica.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
    ...
    "Curtailment ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“ returned home early": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Qualsiasi altro documento che sia rilevante per il tuo sinistro.<br>",
      titles: ["Booking Invoice", "Other Docs"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Other+doc.png",
    ...
    "Flight or Travel delayed": {
      ...
      italian_paragraph:
        "Per favore carica l'informazione richiesta per il tuo sinistro:<br>Documento attestante il viaggio: puÃƒÆ’Ã‚Â² essere la prenotazione del biglietto aereo, una prenotazione, ricevuta albergo o simile.<br>Qualsiasi informazione che possa confermare la motivazione e la durata del ritardo di viaggio.<br>",
      titles: ["Booking Invoice", "Report"],
      images: [
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Booking+Invoices.png",
        "https://ins-multiforms.s3.eu-central-1.amazonaws.com/Document_Icons/Report.png",
      ...
      if (sum <= 5242880) {
        ...
        if (!FileExtensionValidateCounter && !formatValidateCounter) {
          ...
          addErrorMessage(
            ...
            "<p style='color:red;' >ADVERTENCIA - Formato de archivo no compatible adjunto. Por favor, elimÃ­nelo e intente nuevamente.</p><br><p style='color:red;'>ADVERTENCIA - Formato de archivo no compatible adjunto. Por favor, elimÃ­nelo e intente nuevamente.</p>"
          );
          } if(currentUrl.includes('/it/') ){
            addErrorMessage(
              "api_call_failed_filelist",
              "<p style='color:red;' >ATTENZIONE: formato di file allegato non supportato. Rimuovilo e riprova</p><br><p style='color:red;'>Supportiamo i seguenti formati di file: jpeg, jpg, pnh, bmp, pdf, doc, docx, xls e xlsx.</p>"
            );
          } else if(currentUrl.includes('/de/') ){
            addErrorMessage(
              "api_call_failed_filelist",
              "<p style='color:red;' >WARNUNG - Nicht unterstÃ¼tztes Dateiformat angehÃ¤ngt. Bitte entfernen Sie die Datei und versuchen Sie es erneut.</p><br><p style='color:red;'>Wir unterstÃ¼tzen die folgenden Dateiformate: jpeg, jpg, png, bmp, pdf, doc, docx, xls und xlsx.</p>"
            );
          }else if(currentUrl.includes('/fr/') ){
            addErrorMessage(
              "api_call_failed_filelist",
              "<p style='color:red;' >AVERTISSEMENT - Format de fichier joint non pris en charge. Veuillez supprimer et rÃ©essayer</p><br><p style='color:red;'>Nous prenons en charge les formats de fichiers suivants : jpeg, jpg, pnh, bmp, pdf,doc, docx, xls et xlsx.</p>"
            );
          } else if(currentUrl.includes('/pt-PT/') ){
            addErrorMessage(
              "api_call_failed_filelist",
              "<p style='color:red;' >AVISO - Formato de arquivo nÃ£o suportado anexado. Remova e tente novamente</p><br><p style='color:red;'>Suportamos os seguintes formatos de arquivo - jpeg, jpg, pnh, bmp, pdf,doc, docx, xls e xlsx.</p>"
            );
          } else if(currentUrl.includes('/pt-BR/') ){
            addErrorMessage(
              "api_call_failed_filelist",
            ...
            addErrorMessage(
              "api_call_failed_filelist",
              "<p style='color:red;' >ADVERTENCIA - Formato de archivo no compatible adjunto. Por favor, elimÃ­nelo e intente nuevamente.</p><br><p style='color:red;'>Soportamos los siguientes formatos de archivo: jpeg, jpg, png, bmp, pdf, doc, docx, xls y xlsx.</p>"
            );
          } else {
  ...
  function add_section_5() {
    if (currentUrl.includes('/it/')) {
      ...
      $(
        "<strong id='section_5_header'>" + german_titles[4] + "</strong>"
      ).insertAfter("#great_line_4");
      $("<hr class='summary_divider' id='great_line_5'>").insertAfter(
        "#section_5_header"
      );
      ...
      $(
        "<strong id='section_5_header'>" + portuguese_titles[4] + "</strong>"
      ).insertAfter("#great_line_4");
      $("<hr class='summary_divider' id='great_line_5'>").insertAfter(
        "#section_5_header"
      );
      ...
      $(
        "<strong id='section_5_header'>" + spanish_titles[4] + "</strong>"
      ).insertAfter("#great_line_4");
      $("<hr class='summary_divider' id='great_line_5'>").insertAfter(
        "#section_5_header"
      );
      ...
      $(
        "<strong id='section_5_header'>" + french_titles[4] + "</strong>"
      ).insertAfter("#great_line_4");
      $("<hr class='summary_divider' id='great_line_5'>").insertAfter(
        "#section_5_header"
      );
  ...
  function add_section_6() {
    ...
    if (currentUrl.includes('/it/')) {
      ...
      $(
        "<strong id='section_6_header'>" + german_titles[5] + "</strong>"
      ).insertAfter("#great_line_5");
      $("<hr class='summary_divider' id='great_line_6'>").insertAfter(
        "#section_6_header"
      );
      ...
      $(
        "<strong id='section_6_header'>" + portuguese_titles[5] + "</strong>"
      ).insertAfter("#great_line_5");
      $("<hr class='summary_divider' id='great_line_6'>").insertAfter(
        "#section_6_header"
      );
      ...
      $(
        "<strong id='section_6_header'>" + spanish_titles[5] + "</strong>"
      ).insertAfter("#great_line_5");
      $("<hr class='summary_divider' id='great_line_6'>").insertAfter(
        "#section_6_header"
      );
      ...
      $(
        "<strong id='section_6_header'>" + french_titles[5] + "</strong>"
      ).insertAfter("#great_line_5");
      $("<hr class='summary_divider' id='great_line_6'>").insertAfter(
        "#section_6_header"
      );
        ...
        if (flag) {
          ...
          if (statusCode == 500) {
            ...
            // if ($("#title").hasClass("ColumbusItaly")) {
              ...
              addErrorMessage(
                "api_call_failed_banvalidate",
                "Wir kÃ¶nnen die angegebenen Bankkontoinformationen nicht bestÃ¤tigen. Bitte Ã¼berprÃ¼fen Sie alle Details und geben Sie diese nochmals ein. "
              );
            } else if (currentUrl.includes('/pt-PT/')) {  
              addErrorMessage(
                "api_call_failed_banvalidate",
                "NÃ£o podemos processar as informaÃ§Ãµes da conta bancÃ¡ria fornecidas. Por favor, verifique todos os detalhes e reenvie."
              );
            } else if (currentUrl.includes('/pt-PT/')) {  
              addErrorMessage(
                "api_call_failed_banvalidate",
              ...
              addErrorMessage(
                "api_call_failed_banvalidate",
                "No podemos procesar la informaciÃ³n de la cuenta bancaria proporcionada. Por favor, verifica todos los detalles y envÃ­alos nuevamente."
              );
            }  else {
              addErrorMessage(
                "api_call_failed_banvalidate",
        ...
        $(
          ...
          if (new_today < replacement_purchase_date) {
            ...
            if (currentUrl.includes("/it/")) {    
              ...
              addErrorMessage(
                "helpdesk_ticket_custom_field_cf_on_what_date_did_you_purchase_the_replacement_items_2321673",
                "La date doit Ãªtre dans le passÃ©"
              );  
  ...
  $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").change(
    function () {
      if (
        ...
        //   "#helpdesk_ticket_custom_field_cf_please_confirm_the_first_date_of_diagnosis_for_this_condition_2321673"
        // ).hide();
        // $('#helpdesk_ticket_custom_field_cf_please_confirm_the_first_date_of_diagnosis_for_this_condition_2321673').next().hide() //might need to remove
  ...
  $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").change(
    function () {
      if (
        $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").val() == "Any CANCELLATION claim due to COVID-19"
      ) {
        //  Hide on default based on this selection
        ...
        // koreahelpdesk@prioritypass.com.hk
        show_and_hide_3(
    ...
    function () {
      if (
        ...
        $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").change(function () {
          ...
          console.log( $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val())
          ...
          switch (whyDidYouCancelYourTrip) {
            ...
            case "Cancellation of leave by emergency services or armed forces":
              $("label[for='helpdesk_ticket_custom_field_cf_in_your_own_words_please_explain_the_reason_for_cancelling_your_trip_2321673']").show();
        ...
        //when did the symptoms start -past present
        date_past_present("helpdesk_ticket_custom_field_cf_when_did_the_symptoms_start_2321673");
        ...
        //on what date injury
        date_past_present("helpdesk_ticket_custom_field_cf_on_what_date_did_the_incident_causing_the_injury_happen_2321673");
        ...
        date_past_present("helpdesk_ticket_custom_field_cf_on_what_date_were_you_advised_of_the_redundancy_2321673");
        ...
        date_past_present("helpdesk_ticket_custom_field_cf_on_what_date_were_you_advised_of_the_jury_service_or_court_date_2321673");
        ...
        date_past_present("helpdesk_ticket_custom_field_cf_please_confirm_the_date_of_death_2321673");
        //Please confirm the date of diagnosis for this condition
        date_past_present("helpdesk_ticket_custom_field_cf_please_confirm_the_date_of_diagnosis_for_this_condition_2321673");

        //Why did you cancel your trip? - dependancy 8
        //hide by default
        $("label[for='helpdesk_ticket_custom_field_cf_please_confirm_the_date_of_diagnosis_for_this_condition_2321673']").hide();
        $("#helpdesk_ticket_custom_field_cf_please_confirm_the_date_of_diagnosis_for_this_condition_2321673").hide();
        $(".form-group.helpdesk_ticket_custom_field_cf_to_the_best_of_your_knowledge_were_you_or_this_person_considered_stable_at_the_time_of_booking_the_trip_2321673").hide();
        $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").change(function () {
          if (
            $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() == "Illness" ||
            $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() == "Death"
          ) {
            $("label[for='helpdesk_ticket_custom_field_cf_please_confirm_the_date_of_diagnosis_for_this_condition_2321673']").show();
            $("#helpdesk_ticket_custom_field_cf_please_confirm_the_date_of_diagnosis_for_this_condition_2321673").show();
            $(".form-group.helpdesk_ticket_custom_field_cf_to_the_best_of_your_knowledge_were_you_or_this_person_considered_stable_at_the_time_of_booking_the_trip_2321673").show();
          } else {
            $(
  ...
  $("#helpdesk_ticket_custom_field_cf_reason_for_claim_2321673").change(
    function () {
      if (
        ...
        $("#helpdesk_ticket_custom_field_cf_when_did_you_buy_the_item_2321673").next().hide()
        //save_and_continue 4
