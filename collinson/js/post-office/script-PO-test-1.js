    ...
    function () {
      if (
        ...
        $(
          ...
          // if (
          //   $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() == "Coronavirus" ||
          //   $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() == "Other - Select if you're sure it's not listed above" ||
          //   $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() == "Pregnancy" ||
          //   $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() == "Your home or business premises being uninhabitable" ||
          //   $("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() ==
          ...
          // } else if($("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() === "Illness"){
          
          //   $(".form-group.helpdesk_ticket_custom_field_cf_who_advised_to_cancel_2321673").show();
          
          // } else if($("#helpdesk_ticket_custom_field_cf_are_you_currently_still_abroad_2321673").val() === "Injury"){
